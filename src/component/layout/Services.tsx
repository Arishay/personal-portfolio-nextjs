...
function Services() {
    return <div id="Services" className="flex text-white min-h-full flex-col items-center bg-slate-800">
        ...
        <div className="flex desktop:flex-row mobile:flex-col mobile:items-center flex-grow justify-around text-center">
            <Service hl="UI designing" desc="Designing of responsive web apps such as portfolios, landingpages and dashboards" img="/icons/spa.svg" />
            <Service hl="UX Designing" desc="Ux integration into your website for dynamic content delivery" img="/icons/api.svg" />
